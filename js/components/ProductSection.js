export function productSection() {
  ...
  section.innerHTML = `
    ...
    <div class="absolute top-[184px] left-[930px] w-[446px] h-[766px] flex flex-col">
      ...
      <!-- PART 1 : TOP CONTENT -->
      <div class="w-[445px] h-[396.81px] flex flex-col">
        ...
        <div class="flex gap-[90px] mt-[42px]">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs uppercase text-gray-400 h-[16px]">Sex</p>
              <p class="text-sm h-[18px]">Women</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs uppercase text-gray-400 h-[16px]">Poids</p>
              <p class="text-sm h-[18px]">105 gr</p>
            </div>
          </div>
        </div>
      ...
      <!-- PART 3 : QUANTITY + WISHLIST -->
      <div class="flex gap-[28px] w-[443px] h-[60px] mt-[20px]">
      ...
      <!-- PART 4 : BOTTOM INFO -->
      <div class="flex flex-col gap-[24px] w-[446px] mt-[24px]">

        <img src="./assets/icons/free.svg" class="w-[387px] h-[20px]"/>

        <p class="text-xs text-gray-500 w-[437px]">
